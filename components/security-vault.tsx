...
const modules: Module[] = [
  ...
  {
    id: "excel",
    title: "Origen Interno: Excel / CSV",
    icon: <FileSpreadsheet className="h-4 w-4" />,
    fields: [
      { label: "Nombre del archivo", placeholder: "ventas_2026.xlsx" },
      { label: "Hoja / pestana", placeholder: "Hoja1" },
      { label: "Frecuencia de carga", placeholder: "Diaria" },
    ],
  },
  {
    id: "sheets",
    title: "Origen Interno: Google Sheets",
    icon: <Table2 className="h-4 w-4" />,
    fields: [
      { label: "URL del documento", placeholder: "https://docs.google.com/..." },
      { label: "Rango (A1:Z)", placeholder: "A1:Z1000" },
      { label: "Token de acceso", placeholder: "••••••••" },
    ],
  },
]

export function SecurityVault({ scopeLabel }: { scopeLabel?: string } = {}) {
      ...
      <CardHeader className="pb-4">
        <div className="flex items-center justify-between">
          <CardTitle className="text-foreground flex items-center gap-2 text-base">
            ...
            {scopeLabel && (
              <span className="text-muted-foreground ml-1 text-xs font-normal">· {scopeLabel}</span>
            )}
          </CardTitle>
          {!isLocked && (
            <Badge
